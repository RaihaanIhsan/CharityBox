...
$filter_category = '';
$search = '';
$limit = 5;  // Limit to 5 organizations when no filter is applied
...
<head>
    ...
    <!-- Include jQuery for auto-complete functionality -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>

    <!-- Include jQuery UI for the auto-complete functionality -->
        ...
        <div class="filter-section">
            ...
            <form action="organization_list.php" method="POST">
                <select name="category">
                    ...
                    <option value="Clothes" <?php if ($filter_category == 'Clothes') echo 'selected'; ?>>Clothes</option>
                    <option value="Toys" <?php if ($filter_category == 'Toys') echo 'selected'; ?>>Toys</option>
                </select> -->

                <!-- Location input with auto-complete -->
                <input type="text" id="location" name="location" placeholder="Type or choose a location" value="<?php echo $filter_location; ?>">
